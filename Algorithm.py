...
def draw(draw_info, algo_name, ascending):
	...
	draw_info.window.blit(title, (draw_info.width/2 - title.get_width()/2,60))
	
	controls = draw_info.FONT.render("R-Reset | SPACE-Start | A-Ascending | D-Dscending", 1, draw_info.BLACK)
